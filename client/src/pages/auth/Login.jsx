    ...
    <div>
      ...
      <div className="flex w-2/3 items-center justify-center m-auto mt-28 bg-white rounded-3xl overflow-hidden">
        <div className="w-1/2 flex flex-col items-center">
          <div className="pb-10">
            <p className="text-5xl font-bold text-primary">Welcome To Our Portal</p>
          </div>
          <form
          ...
          >
            <input
              ...
              className="w-full border border-primary rounded-lg text-sm outline-none focus:ring-1 focus:ring-primary focus:border-primary active:outline-none active:ring-1 active:ring-primary active:border-primary"
            />
            <input
              type="password"
